            ...
            <div className="w-full md:w-1/3 border-r border-border bg-card/50 flex flex-col">
                <div className="p-4 border-b border-border">
                    <h1 className="text-xl font-bold text-foreground mb-4 flex items-center gap-2">
                        <Mail className="w-5 h-5 text-vogo-blue" /> Gelen Kutusu
                    </h1>
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-background border border-border rounded-xl pl-10 pr-4 py-2 text-sm text-foreground focus:outline-none focus:border-vogo-blue"
                        />
                    </div>
                </div>
                    ...
                    {messages.length === 0 ? (
                        ...
                        messages.map((msg) => (
                            <div
                                ...
                                className={`p-4 border-b border-border cursor-pointer hover:bg-muted/50 transition-colors ${selectedId === msg.id ? 'bg-vogo-blue/5 border-l-2 border-l-emerald-500' : 'border-l-2 border-l-transparent'}`}
                            >
                ...
                {selectedMessage ? (
                    <>
                        ...
                        <div className="p-4 border-t border-border bg-card/30">
                            <a href={`mailto:${selectedMessage.email}?subject=Ynt: ${selectedMessage.subject}`} className="inline-flex px-6 py-3 bg-vogo-blue text-white rounded-xl font-bold hover:bg-vogo-teal transition-colors items-center gap-2">
