...
const STATIC_TABS = ["Tüm Projeler", "Headless CMS", "Headless eCommerce", "Next.JS", "AI Integrations", "Next.JS Audit"]
...
export default function PortfolioPage() {
    ...
    const filteredProjects = projects.filter(project => {
        if (selectedCategory === "Tüm Projeler") return true
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
                                ...
                                {filteredProjects.length === 0 && !loading && (
                                    <div className="col-span-full text-center py-32">
                                        <p className="text-black/40 font-medium text-lg">Bu kategoride henüz proje bulunmuyor.</p>
                                    </div>
                                )}
                            </div>
                        )}
