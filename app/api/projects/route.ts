...
export async function POST(request: NextRequest) {
    try {
        ...
        const newProject = {
            ...
            thumbnailType: body.thumbnailType || 'image',
            ...
            accordionImage: body.accordionImage || null,
            accordionImageType: body.accordionImageType || 'image',
...
export async function PUT(request: NextRequest) {
    try {
        ...
        const sanitizedData: any = {
            ...
            showOnHomepage: updateData.showOnHomepage ?? false,
            ...
            thumbnailType: updateData.thumbnailType || 'image',
            liveUrl: updateData.liveUrl,
            tags: updateData.tags,
            contentBlocks: updateData.contentBlocks,
            accordionImage: updateData.accordionImage,
            accordionImageType: updateData.accordionImageType || 'image',
            updatedAt: new Date().toISOString()
        }
