        ...
        <div className="p-8 max-w-7xl mx-auto gradient-mesh space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <Link href="/admin/projects/new">
                    <button className="bg-vogo-blue hover:bg-vogo-teal text-white px-6 py-3 rounded-xl font-bold transition-all shadow-lg shadow-vogo-blue/20 flex items-center gap-2 active:scale-95">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project) => (
                    <div key={project.id} className="group glass-card rounded-2xl overflow-hidden hover:border-vogo-blue/50 transition-all flex flex-col h-full">
                        ...
                        <div className="p-6 flex flex-col flex-1">
                            <h3 className="text-xl font-bold text-foreground mb-1 group-hover:text-vogo-aqua transition-colors line-clamp-1">{project.publicTitle || project.title || project.name}</h3>
                ...
                <Link href="/admin/projects/new" className="block h-full min-h-[300px]">
                    <button className="w-full h-full border-2 border-dashed border-border rounded-3xl flex flex-col items-center justify-center text-slate-500 hover:text-vogo-blue hover:border-vogo-blue/50 hover:bg-slate-900/50 transition-all group">
