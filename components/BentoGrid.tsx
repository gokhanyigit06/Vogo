            ...
            <div className="container mx-auto px-4 md:px-8 max-w-7xl relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-sm text-emerald-400 font-medium">Neden Bizi Seçmelisiniz?</span>
                    </motion.div>
                    ...
                    <p className="text-xl text-slate-400 leading-relaxed">
                        ...
                        <span className="text-emerald-400 font-semibold"> tek bir çatı altında</span>
                    </p>
                </motion.div>
                    ...
                    {bentoItems.map((item, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`${colSpan} ${rowSpan} group relative rounded-3xl bg-slate-900/50 backdrop-blur-sm border border-slate-800 hover:border-slate-700 overflow-hidden cursor-pointer`}
                            >
                                {/* Gradient Background */}
                                ...
                                <div className="relative z-10 p-8 h-full flex flex-col justify-between">
                                    <div className="space-y-4">
                                        ...
                                        {/* Title & Description */}
                                        <div>
                                            <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-emerald-400 group-hover:to-teal-400 transition-all">
                                                {item.title}
                                            </h3>
